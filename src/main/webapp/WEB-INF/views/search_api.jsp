...
<html lang="ko">
	...
	<body>
		...
		<script src="https://dapi.kakao.com/v2/maps/sdk.js?appkey=f53333eaffcfe200f22026547121b3c1"></script>
		<script>
			...
			function displayMarkers(restaurants) {
				...
				restaurants.forEach(function (restaurant) {
					...
					kakao.maps.event.addListener(marker, "click", function () {
						...
						// 클릭한 마커 정보를 아래에도 표시
						const clickedMarkerInfo =
							document.getElementById("clickedMarkerInfo");
